...
>>>>>>> 7ffaa9ff21e6b4b2f4bb3689ea4d6e6948d4cac6
...
def index(request):
    return render(
        ...
        "reportes/index.html",
        {
            "rentas": _rentas_queryset(request)[:100],
...
>>>>>>> 7ffaa9ff21e6b4b2f4bb3689ea4d6e6948d4cac6
    ...
    response["Content-Disposition"] = (
        'attachment; filename="cinegest-rentas.xlsx"'
    )
...
<<<<<<< HEAD
    ...
    story.append(
        Paragraph(
            f"Resumen operativo generado el {fecha_generacion}.",
            subtitle_style,
        )
    )
    ...
    total_rentas = len(rentas)

    total_general = sum(
        (renta.total for renta in rentas),
        Decimal("0.00"),
    )
    ...
    if filtros["estado"] != "Todos":
        estado_display = dict(Renta.Estado.choices).get(
            filtros["estado"],
            filtros["estado"],
        )
    ...
    filtros_data = [
        [
            ...
            (
                f"Desde: {filtros['desde']}   |   "
                f"Hasta: {filtros['hasta']}   |   "
    ...
    if rentas:
        ...
        empty_data = [
            [
                Paragraph(
                    "<b>No se encontraron rentas</b><br/>"
    ...
    response["Content-Disposition"] = (
        'attachment; filename="cinegest-rentas.pdf"'
    )
