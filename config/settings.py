...
if not DEBUG:
    if SECRET_KEY in {DEV_SECRET_KEY, "change-me"} or len(SECRET_KEY) < 32:
        raise ImproperlyConfigured(
            "DJANGO_SECRET_KEY debe configurarse con un valor robusto antes de ejecutar CineGest en producción."
        )
